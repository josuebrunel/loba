...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QmlManager_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 40, 13)
    ...
    "QmlManager\0slotStartChat\0\0slotStopLogin\0"
    "slotSendLogin"
};
...
void QmlManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->slotStartChat(); break;
        case 1: _t->slotStopLogin(); break;
        case 2: _t->slotSendLogin((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])),(*reinterpret_cast< QString(*)>(_a[3]))); break;
        default: ;
        }
    }
}
...
const QMetaObject QmlManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QmlManager.data,
      qt_meta_data_QmlManager,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QmlManager.stringdata))
